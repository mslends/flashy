angular.module("flashCards").service("flashCardService", function($firebaseObject, $firebaseArray, $stateParams) {
...
var mypostFirebaseRef = new Firebase("https://flashington.firebaseio.com/-KFlALUT2_FKchYLeuOL");
...
this.addNewTopic = function(topic) {
  ...
  var mypostFirebaseRef2 = new Firebase("https://flashington.firebaseio.com/-KFlALUT2_FKchYLeuOL/"+topic.name);
...
this.deleteTopic = function(topic) {
    console.log("Reached the service", topic.name);
  var deleteTopicFirebaseRef = new Firebase("https://flashington.firebaseio.com/-KFlALUT2_FKchYLeuOL/"+topic.name);

  deleteTopicFirebaseRef.remove(onComplete);
...
this.deleteCard = function(card, collection) {
